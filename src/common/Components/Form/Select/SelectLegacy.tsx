import React, { Children, ReactElement, ReactNode, memo, useCallback, useEffect, useState } from "react";
...
const SelectLegacy = ({
  ...
  const getClassNameByPosition = useCallback((positionParam: SelectPositionEnum) => {
