...
const DatePickerDropdown = ({
  ...
  const rangeList = useMemo(
    () => [
      { name: DatePickerRangeNameEnum.TODAY, label: t("today") },
      { name: DatePickerRangeNameEnum.YESTERDAY, label: t("yesterday") },
      { name: DatePickerRangeNameEnum.LAST_7_DAYS, label: t("last7days") },
      { name: DatePickerRangeNameEnum.LAST_30_DAYS, label: t("last30days") },
      { name: DatePickerRangeNameEnum.THIS_MONTH, label: t("thisMonth") },
      { name: DatePickerRangeNameEnum.LAST_MONTH, label: t("lastMonth") },
      { name: DatePickerRangeNameEnum.CUSTOM_RANGE, label: t("custom") },
    ],
    [t],
  );
