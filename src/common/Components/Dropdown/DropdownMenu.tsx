import { MouseEvent, cloneElement, memo, useCallback, useEffect, useMemo, useRef } from "react";
...
const DropdownMenu = ({
  ...
  const dropdownContainer = useMemo(() => window.document.querySelector(".kmovie-dropdown-container"), []);
