 ...
 */
const useQueryParam = (defaultQueryParam?: BaseListQueryType): UseQueryParamResultType => {
  const [queryParam, setQueryParam] = useState<BaseListQueryType | null>(null);

  const handleChange: Dispatch<SetStateAction<BaseListQueryType>> = useCallback((data) => {
    setQueryParam((prev) => {
